...
export default function Navbar({ variant = "default" }) {
	...
	return (
		<nav className={navClass + " fade-section-down fade-section--delay-1 flex flex-row justify-between align-center"}>
			<div className="navbar-logo fade-section-down fade-section--delay-1">
				<Url href={'/'}>
					<Logo />
				</Url>
			</div>
			<div className="navbar-links fade-section-down fade-section--delay-2 flex flex-row items-center justify-center">

                    ...
                    <article className="hello-card flex flex-col items-start justify-start">
                        ...
                        <div className={'hello-card-content flex flex-col items-start justify-start'}>
                            <div className={'hello-card-content-text flex flex-col items-start justify-start'}>
                                <p className="t-copy">
                                    I am a digital designer with over a decade of experience collaborating with start up founders, content, marketing and product teams to deliver clear, scalable digital experiences.
                                </p>
                                <p className="t-copy">
                                    From product interfaces to brand and web platforms, I work closely to align user needs, strategy, and execution in ways that support long-term growth.
                                </p>
                            </div>
